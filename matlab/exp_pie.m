...
lambda = 0.1; lambda_l0graph = 0.002; maxIter_l1graph_admm = 10000; maxIter_l0graph = 100; 
...
for i = 1:nK,
    ...
    [perf_pie{i},l1graph_alpha,l0graph_alpha] = run_perf_comp(data_k_class,k,tlabel_k_class,km_opt,lambda,lambda_l0graph,maxIter_l1graph_admm,maxIter_l0graph,smce_kmax,omp_Ts,...
    ...
    fprintf('cmu pie %d cluster result: \n', i);
    perf_pie{i}
end
